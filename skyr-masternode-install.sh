...
COIN_TGZP='https://github.com/DiplexSoftfork/Skyrcoin/releases/download/v2.0.0.9-cs/skyrcoin-2.0.0.9-cs-linux-gnu-x64.tar.gz'
COIN_BOOTSTRAP='https://github.com/DiplexSoftfork/Skyrcoin/releases/download/v2.0.0.8b/bootstrap.tar.gz'
